...
urlpatterns = [
    ...
    path('debug/bus_status/<int:bus_id>/', views.debug_bus_status, name='debug_bus_status'),
...
path('driver/verify-reset-otp/', views.driver_verify_reset_otp, name='driver_verify_reset_otp'),
path('driver/set-new-password/', views.driver_set_new_password, name='driver_set_new_password'),
